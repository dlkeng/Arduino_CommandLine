...
(see link:https://github.com/dlkeng/Arduino_CommandLine/docs/html/class_command_line.html[CommandLine Web Page] and CommandLineTest.ino and CommandLineCustomErrs.ino examples)
---------------------------------
